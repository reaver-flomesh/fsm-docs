...
1. Update the `redirects` in `netlify.toml` on the main branch to redirect `https://fsm-docs.flomesh.io/` to `https//release-vX-Y.docs.openservicemesh.io/` where `release-vX-Y` is the newest release.
