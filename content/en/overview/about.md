...
The Flomesh Service Mesh (FSM) inherits a portion of the archived [FSM](https://github.com/openservicemesh/osm) code and introduces the following enhancements while maintaining compatibility with FSM:
