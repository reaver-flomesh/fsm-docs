...
FSM Dashboards are available through [FSM GitHub repository](https://github.com/flomesh-io/fsm/tree/{{< param fsm_branch >}}/charts/fsm/grafana/dashboards), which can be imported as json blobs on the management application.
